...
Сайт за осиновяване на шест спасени котенца. Направен с [Astro](https://astro.build) +
[Tailwind CSS](https://tailwindcss.com), публикуван чрез GitHub Pages на `gushni.me`.

## Как да добавиш ново коте

1. Копирай някой от файловете в `src/content/cats/` (напр. `simba.md`) и го преименувай на
...
2. Попълни frontmatter-а:
   ...
   relatedCats: ["simba", "luna"]   # имената на файловете на свързаните котета, незадължително
   ---
   ```
